...
| `mwwhg` | Mission & delivery | 2026-07-07 | @mwwhg asked to fill his own team slot, providing his name, role, focus line, and GitHub avatar — a self-directed consent, confirming he understands the page is public, open-source (CC BY 4.0), world-readable and cached beyond our control, that the avatar is his to publish, and that he may be removed at any time. | Name: Matt Wood. Photo: his own public GitHub avatar (github.com/u/266846041) copied to spec, saved to `web/public/team/mwwhg.jpg`. |
| `product-strategy` | Product & facilitation | 2026-07-08 | Klaus Bravenboer made a self-directed request in Codex to be listed on the public team page, supplied his own profile photo for the draft, and asked to review it locally before a PR. | Name: Klaus Bravenboer. Photo: self-supplied profile photo copied to `web/public/team/product-strategy.jpg`. |
