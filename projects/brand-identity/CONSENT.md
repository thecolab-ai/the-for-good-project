...
| `partnerships` | Partnerships & field | 2026-07-04 | @rachel-rowanadvisory (the project's demand-side/partnerships connector) asked to fill her own team slot with her name and photo — a self-directed consent, made after taking the collaborator role on the project. | Name: Rachel McBride. Photo: her own professional headshot (hers to publish), cropped to spec and saved to `web/public/team/rachelmcbride.jpg`. |
