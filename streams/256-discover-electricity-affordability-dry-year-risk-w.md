...
- **A renter-access solar options paper** — helps: groups exploring community, public-housing or shared-solar models for people who cannot use their own roof. Effort: Medium. Supported by the [solar-economics](../research/findings/other/nz-solar-deployment-economics.md) (Medium) and [new-generation](../research/findings/other/renewable-pipeline-hydro-marginal-pricing.md) (Medium) findings. Would need: a workable NZ legal and billing model for tenants or community members to receive benefits without taking roof ownership or long contract risk.
