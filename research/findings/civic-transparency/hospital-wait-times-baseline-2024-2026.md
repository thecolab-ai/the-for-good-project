...
The DPMC Target 1 factsheet and RNZ reporting attribute the Q1 (Jul–Sep, NZ winter) dip in ED performance explicitly to "increased winter demand (in line with historical patterns)," with results recovering in Q2/Q3. [DPMC, Target 1 factsheet, Dec 2025](https://www.dpmc.govt.nz/sites/default/files/2026-03/gt-factsheet-target-1-dec25.pdf). The DPMC Target 2 factsheet, which covers elective treatment rather than ED, separately attributes its own Q2→Q3 elective-treatment dip (65.9%→64.5%) to "seasonal patterns" — the same kind of seasonal framing, but a different measure and quarter-pair, not direct support for the ED claim. [DPMC, Target 2 factsheet, Mar 2026](https://www.dpmc.govt.nz/sites/default/files/2026-06/gt-factsheet-target-2-mar26.pdf).
...
No district ranks in the bottom five on all three measures (checked across all 20 districts' bottom-five lists for each measure). The top five is different: **Lakes is a consistent top-five performer on all three** — 5th on ED (83.4%), 1st on FSA (87.9%), 4th on elective (75.5%) — making it the closest thing in this baseline to an across-the-board strong performer, and a natural best-practice case study. Beyond Lakes, no other district repeats across all three top-five lists — e.g. West Coast is the best ED performer but only 4th on elective treatment (86.0%) and outside the FSA top five, while MidCentral is the worst ED performer (59.2%) but a top-three FSA (74.8%) and elective (81.3%) performer. Health NZ publishes these as three separately-ranked district tables in the same document, and the same Lakes/West Coast/MidCentral pattern recurs in the prior quarter's factsheets too (spot-checked against the Q2 25/26 national/district factsheet index). [Health NZ, district and regional factsheets 2025/26](https://www.healthnz.govt.nz/publications/district-and-regional-factsheets-2025-26).
