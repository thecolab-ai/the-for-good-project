...
8. New Zealand Legislation, Regulatory Systems (Primary Industries) Amendment Bill, re-verified 2026-07-08 — direct plain-HTTP fetch now resolves cleanly (no WAF challenge) via the upgraded fetch ladder -- https://www.legislation.govt.nz/bill/government/2023/256/en/latest/
