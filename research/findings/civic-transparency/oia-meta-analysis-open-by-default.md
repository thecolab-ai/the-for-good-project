...
- **Hard guardrail:** FYI publishes each request and the requester's real name publicly ("Your name is tangled up with your request, so has to be published as well"), and request bodies can incidentally name third parties — so any analysis must work on aggregate metadata and be de-identified by construction. And the headline cost figure, while credible and multiply-reported, is a **single government-commissioned estimate** with a known Police confound — both must be handled honestly by the children before a steward relies on them. [FYI, Privacy](https://fyi.org.nz/help/privacy)
...
The core justification for this stream is that responding to OIA requests one at a time is expensive and growing. A report by consultancy firm TBL (Tregaskis Brown), commissioned via the Ministry of Justice, put the annual cost of responding to OIA requests at $183.6m in the 2024/25 financial year — up from $46.7m in 2015/16, a 293% rise — and forecast it to roughly double again to $342m by 2030/31. RNZ's account of the report also notes a 394% growth in the *number* of requests over that decade but does not give an absolute count. [RNZ, 12 June 2026](https://www.rnz.co.nz/news/political/597952/the-toothless-official-information-law-keeping-us-in-the-dark) The NZ Herald, reporting the same TBL/MoJ modelling, is the source for the absolute request volume: agencies spent that $183.6m "responding to almost 159,000 requests" in 2024/25. [NZ Herald](https://www.nzherald.co.nz/nz/politics/ai-and-transparency-how-government-agencies-could-avoid-ballooning-oia-costs/2QH4WSXJSFDWVJCWJMYPBHOT24/)
...
Cabinet's Declaration on Open and Transparent Government (approved by Cabinet on 8 August 2011) commits the government to "actively releasing high value public data," supported by the New Zealand Data and Information Management Principles (NZDIMP) and the NZGOAL (New Zealand Government Open Access and Licensing) framework. [data.govt.nz, Declaration on Open and Transparent Government](https://www.data.govt.nz/toolkit/policies/declaration-on-open-and-transparent-government); [data.govt.nz, Open data policies](https://www.data.govt.nz/toolkit/policies/open-data-policy) These datasets are catalogued in the all-of-government data.govt.nz open-data directory, run by the Department of Internal Affairs. [data.govt.nz, About](https://www.data.govt.nz/about/about-data-govt-nz); [digital.govt.nz, data.govt.nz open data catalogue](https://www.digital.govt.nz/products-and-services/products-and-services-a-z/data-govt-nz-open-data-catalogue)
...
|---|---|---|---|
| Responding to OIA requests cost NZ ~$183.6m in 2024/25 across ~159,000 requests, rising toward $342m by 2030/31. | [RNZ, 12 Jun 2026](https://www.rnz.co.nz/news/political/597952/the-toothless-official-information-law-keeping-us-in-the-dark) — cost, 293% rise and $342m forecast (RNZ gives request *growth* of 394%, not an absolute count) | [NZ Herald](https://www.nzherald.co.nz/nz/politics/ai-and-transparency-how-government-agencies-could-avoid-ballooning-oia-costs/2QH4WSXJSFDWVJCWJMYPBHOT24/) — source for the "almost 159,000 requests" count as well as the same cost/forecast | Medium — two independent outlets, but **one origin**: the TBL/MoJ modelling. Not two independent measurements. |
| The Ministry of Justice's OIA cost report recommends agencies proactively release more information to manage volume/cost. | [NZ Herald](https://www.nzherald.co.nz/nz/politics/ai-and-transparency-how-government-agencies-could-avoid-ballooning-oia-costs/2QH4WSXJSFDWVJCWJMYPBHOT24/) | *Single-origin — the recommendation is attributed to the MoJ/TBL report itself; no independent second source exists. NZ's separate proactive-release regime ([PSC](https://www.publicservice.govt.nz/guidance/official-information/proactive-release)) is context, not corroboration.* | Low — single-origin, like the cost figure above. |
...
9. FYI.org.nz. "Privacy." Accessed 3 July 2026. https://fyi.org.nz/help/privacy
10. data.govt.nz. "Declaration on Open and Transparent Government." Accessed 3 July 2026. https://www.data.govt.nz/toolkit/policies/declaration-on-open-and-transparent-government
11. data.govt.nz. "Open data policies." Accessed 3 July 2026. https://www.data.govt.nz/toolkit/policies/open-data-policy
12. data.govt.nz. "About data.govt.nz." Accessed 3 July 2026. https://www.data.govt.nz/about/about-data-govt-nz
13. Digital.govt.nz. "Data.govt.nz open data catalogue." Accessed 3 July 2026. https://www.digital.govt.nz/products-and-services/products-and-services-a-z/data-govt-nz-open-data-catalogue
14. Law Commission. "Report 125: The Public's Right to Know — Chapter 12: The trend towards proactive release and open data." Accessed 3 July 2026. http://r125.publications.lawcom.govt.nz/chapter+12:+proactive+release+and+publication/chapter+12:+the+trend+towards+proactive+release+and+open+data
15. The For Good Project. "Streams, human gates, and where people actually fit." Accessed 3 July 2026. https://github.com/thecolab-ai/the-for-good-project/blob/main/docs/STREAMS.md
16. GitHub. "Issue #199: discover — make NZ govt legible: meta-analysis of OIA requests." Accessed 3 July 2026. https://github.com/thecolab-ai/the-for-good-project/issues/199
