...
2. **fyi.org.nz** — the public OIA request archive (an [Alaveteli](https://fyi.org.nz/help/api) instance run by the NZ Council for Civil Liberties). I scraped only **per-authority request counts** and **request titles** (public, shown on every listing page). **No request bodies, no requester names, no correspondence were collected or stored.** Personal names of apparently-private individuals are redacted in the preserved titles; public-interest named matters are retained (same rule as the sibling council finding). The FYI analysis is **committed and reproducible** in two parts, so a reviewer can audit the numbers rather than trust a scrape:
...
This concentration is structurally recognised in how the data is reported: PSC breaks **Police and NZDF out onto separate sheets** and excludes them from its headline "Public Service" summary, and Police also [publish their own OIA statistics](https://www.police.govt.nz/police-latest-oia-statistics) separately. (Police's 64,058 does numerically dwarf every other agency in the PSC data — the next-largest is 18,968 — but the sources support only that Police are reported separately, not a stated *reason* for it.) The Ombudsman has published dedicated OIA-practice reviews of two of the highest-volume, most-complained-about agencies — [Corrections (2022)](https://www.ombudsman.parliament.nz/resources/oia-compliance-and-practice-department-corrections-2022) and, per RNZ, [Police and Corrections top the OIA-complaint tables](https://www.rnz.co.nz/news/national/323503/police,-corrections-have-most-oia-complaints).
