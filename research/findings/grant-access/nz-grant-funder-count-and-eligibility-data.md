---
title: "New Zealand has no official register of grant funders — the largest published database count is ~1,650 funders across ~3,400 schemes, and eligibility criteria live in commercial databases and funder web pages, machine-readable in places but nowhere open-licensed or national"
domain: "grant-access"
issue: "#5"
confidence: "Medium"
author: "mcinteerj"
...
# New Zealand has no official register of grant funders — the largest published database count is ~1,650 funders across ~3,400 schemes, and eligibility criteria live in commercial databases and funder web pages, machine-readable in places but nowhere open-licensed or national
...
This is the largest *published* count, not necessarily the largest database: Strategic Grants markets GEMS as "New Zealand's largest and most current grants database" [Strategic Grants, GEMS](https://www.strategicgrants.co.nz/gems/) but publishes no scheme or funder counts, so the competing claims cannot be adjudicated. Both are vendor marketing; only Fundsorter's is a number.
...
| The largest *published* database count is ~1,650 funders / ~3,361 opportunities (Fundsorter) | [Fundsorter homepage](https://www.fundsorter.com/) (live counter, 2 July 2026) | Direct counter-claim exists without numbers: GEMS is marketed as "New Zealand's largest and most current grants database" [Strategic Grants](https://www.strategicgrants.co.nz/gems/) | Low–Medium — both vendor claims; only Fundsorter publishes a figure, so "largest published count" is the strongest supportable wording |
