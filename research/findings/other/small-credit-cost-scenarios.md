...
RBNZ's C5 sector-lending series summarises lending by banks and non-bank lending institutions across housing, personal, business and agricultural lending. Its `hc5.xlsx` data file (re-downloaded 8 Jul 2026 through the upgraded fetch ladder) shows total personal-consumer lending of about $14,460 million as at May 2026, split between registered banks (about $7,293 million) and non-bank lending institutions (about $7,167 million) — confirming non-bank lenders hold roughly half of NZ personal-consumer credit, not a marginal slice. [RBNZ C5, released 30 Jun 2026](https://www.rbnz.govt.nz/statistics/series/lending-and-monetary/registered-banks-and-non-bank-lending-institutions-sector-lending); [RBNZ C5 data file hc5.xlsx, accessed 8 Jul 2026](https://www.rbnz.govt.nz/-/media/project/sites/rbnz/files/statistics/series/c/c5/hc5.xlsx); [RBNZ data-file index, accessed 2 Jul 2026](https://www.rbnz.govt.nz/statistics/series/data-file-index-page)
...
- RBNZ's `hc5.xlsx` C5 spreadsheet is now reachable (re-downloaded 8 Jul 2026 via the upgraded fetch ladder / Jina reader after direct fetches returned an Incapsula-blocked HTML page), so the earlier-removed May 2026 personal-consumer figure is restored above ($14,460m total; $7,293m registered banks, $7,167m non-bank). The C12 credit-card spreadsheet has not been re-pulled here because no C12 dollar figure is load-bearing for the worked scenarios. [RBNZ C5 data file hc5.xlsx, accessed 8 Jul 2026](https://www.rbnz.govt.nz/-/media/project/sites/rbnz/files/statistics/series/c/c5/hc5.xlsx); [RBNZ data-file index, accessed 2 Jul 2026](https://www.rbnz.govt.nz/statistics/series/data-file-index-page)
- Westpac's credit-card pages are now reachable (the landing page fetched at HTTP 200 on 8 Jul 2026, and the rates/fees page rendered via the fetch ladder after the earlier 403 to command-line fetches), so the Kiwibank card figures can now be cross-checked against a second bank: Westpac discloses a Fee Free Mastercard purchase rate of 12.90% p.a. and cash-advance rate of 19.95% p.a., with its rewards cards (Airpoints/hotpoints) at 20.95% p.a. on purchases (16.95% p.a. on the World variants) and 22.95% p.a. on cash advances. Westpac's low-rate card thus matches Kiwibank's 12.90% p.a. Zero Visa purchase rate used in the worked examples, so the scenario arithmetic is not Kiwibank-specific. [Westpac credit cards, accessed 8 Jul 2026](https://www.westpac.co.nz/credit-cards/); [Westpac cards terms, fees and rates, accessed 8 Jul 2026](https://www.westpac.co.nz/about-us/legal-information-privacy/cards-terms-fees-rates/)
...
23. Reserve Bank of New Zealand, C5 sector-lending data file "hc5.xlsx", accessed 8 July 2026. https://www.rbnz.govt.nz/-/media/project/sites/rbnz/files/statistics/series/c/c5/hc5.xlsx
24. Westpac, "Credit cards", accessed 8 July 2026. https://www.westpac.co.nz/credit-cards/
25. Westpac, "Cards terms, fees and rates", accessed 8 July 2026. https://www.westpac.co.nz/about-us/legal-information-privacy/cards-terms-fees-rates/
