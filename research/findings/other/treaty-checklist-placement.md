...
- **This mirrors how the NZ Crown places its own Treaty check:** as a *standing analytical step embedded in the process* (from the very start, and most important precisely where interests aren't obvious), with the *how-to questions living in a separate referenced guidance doc* — not duplicated into every template. Two independent official sources support this (see below).

**Overall confidence:** Medium — the *factual* claims (what each repo doc contains today; how NZ government guidance places Treaty analysis) are High and double-sourced; the *recommendation itself* is a design judgement offered for a human steward, not a fact, so the headline is deliberately Medium.
...
|---|---|---|---|
| NZ official practice places Treaty consideration as a **default** analytical step from the very start — and treats it as *more* important where interests aren't obvious — not as a trigger condition | [DPMC Treaty analysis tool](https://www.dpmc.govt.nz/our-programmes/policy-project/policy-tools/treaty-waitangi-analysis) ([archived](https://web.archive.org/web/20260618223901/https://www.dpmc.govt.nz/our-programmes/policy-project/policy-tools/treaty-waitangi-analysis)) | [LDAC Guidelines ch.5](https://www.ldac.org.nz/guidelines/legislation-guidelines-2021-edition/constitutional-issues-and-recognising-rights-2/chapter-5) ([archived](https://web.archive.org/web/20251225090118/https://www.ldac.org.nz/guidelines/legislation-guidelines-2021-edition/constitutional-issues-and-recognising-rights-2/chapter-5/)) | High |
