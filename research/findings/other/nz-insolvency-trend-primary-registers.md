...
- **The Insolvency and Trustee Service (Official Assignee) covers only a subset — about a tenth — of liquidations.** ITS publishes month-by-month totals of liquidations the Official Assignee administers since 2013; the OA was appointed liquidator in about **10.6%** of NZ liquidations in 2022/23 (≈253 companies), so ITS data is **not** a whole-of-market series and must not be substituted for the Companies Office register counts. [ITS corporate insolvency statistics](https://www.insolvency.govt.nz/about/statistics/corporate-insolvency-statistics); [ITS Statistical Data Report 2022/23](https://www.insolvency.govt.nz/assets/pdf/Statistical-Data-Reports/its-statistical-data-report-2022-23.pdf)

**Overall confidence:** High — the trend, the 2026 year-to-date, the seasonality, and the rate are read directly from the Companies Office primary CSVs (fetched and summed independently). The ITS subset share is Medium (one report, corroborated by my own sum of the live ITS table).
...
Liquidations fell to a pandemic-era low of **1,379 in 2021** (business-support settings and a lull in creditor enforcement), then rose in every subsequent full year to **2,867 in 2025**. The 2025 total is the highest annual count since **2010 (3,024)** and exceeds 2011 (2,744), but remains below the GFC peak of **3,431 in 2009**. [Companies Office annual CSV](https://www.companiesoffice.govt.nz/assets/companies-office/company-statistics/yearly-company-statistics-since-2001.csv)

### 2026 year-to-date: above prior years, but not monotonic — and dominated by seasonality
...
**Month-on-month comparisons are the wrong lens because of strong seasonality.** January is depressed every year — 41 (2021), 47 (2022), 53 (2023), 63 (2024), 95 (2025), 117 (2026) — because the courts and the register run down over the December–January holiday period, so most court-ordered liquidations bunch into February onwards. The right frames are **year-on-year** for a given month or **cumulative year-to-date**, both of which show 2026 above prior years. [Companies Office monthly CSV](https://www.companiesoffice.govt.nz/assets/companies-office/company-statistics/monthly-company-statistics-since-2001.csv)
...
The Official Assignee is appointed only in a minority of cases — those court-ordered liquidations where no private (registered) liquidator is nominated. ITS's Statistical Data Report says **2,389** companies were placed into liquidation in 2022/23 and the Official Assignee was appointed liquidator of **10.6%** of them (≈253). [ITS Statistical Data Report 2022/23](https://www.insolvency.govt.nz/assets/pdf/Statistical-Data-Reports/its-statistical-data-report-2022-23.pdf) I independently corroborated this: summing the live ITS monthly OA-administered table across the 2022/23 financial year (July 2022 – June 2023) gives **≈251** appointments, matching the 10.6% figure. [ITS monthly ITS-administered liquidations](https://www.insolvency.govt.nz/about/statistics/corporate-insolvency-statistics/monthly-its-administered-liquidations)

Two cautions follow. First, **ITS ≠ total**: the OA-administered series covers only about a tenth of liquidations, so it cannot stand in for the Companies Office whole-of-market count. Second, **the two official sources count on different bases**: ITS reports a whole-of-market figure of 2,389 for the 2022/23 *financial* year, whereas the Companies Office register series records roughly 1,750–1,800 liquidations across the comparable period on a *calendar/appointment-recorded* basis. The gap is a definitional difference (financial vs calendar year, and how each register dates and scopes a "liquidation"), so the two series should never be mixed within one comparison. Summing the ITS OA-administered table also shows the subset rising alongside the whole (roughly 251 in FY2022/23 to the high-500s in FY2024/25, on my own aggregation), consistent with the Companies Office trend. [ITS corporate insolvency statistics](https://www.insolvency.govt.nz/about/statistics/corporate-insolvency-statistics); [Companies Office annual CSV](https://www.companiesoffice.govt.nz/assets/companies-office/company-statistics/yearly-company-statistics-since-2001.csv)
...
| "Rising month on month" is wrong: 2026 liquidations fell 34% March→April before recovering; January is seasonally depressed every year. | [Companies Office monthly CSV](https://www.companiesoffice.govt.nz/assets/companies-office/company-statistics/monthly-company-statistics-since-2001.csv) | [Companies Office latest company statistics (June 2026 monthly counts)](https://www.companiesoffice.govt.nz/insights-and-articles/latest-company-statistics/) | High |
...
| The Official Assignee administers only ~10.6% of liquidations (2022/23), so ITS is a subset, not a whole-of-market series. | [ITS Statistical Data Report 2022/23](https://www.insolvency.govt.nz/assets/pdf/Statistical-Data-Reports/its-statistical-data-report-2022-23.pdf) | My independent sum of the [ITS monthly OA-administered table](https://www.insolvency.govt.nz/about/statistics/corporate-insolvency-statistics/monthly-its-administered-liquidations) (≈251 for FY2022/23) | Medium |
...
- **A better within-year denominator.** I used year-end register stock for 2021/2024/2025; I could not directly fetch year-end stock for 2022 and 2023 (only quarter-end snapshots), so the rate table shows endpoints rather than every year. A full annual register-stock series (the Companies Office says its annual data file carries the "balance of companies on the register" from 2001) would let a reviewer compute the rate for every year; it would sharpen, not reverse, the finding.
- **The ITS subset share.** The 10.6% figure is from a single 2022/23 ITS report (its PDF returned a 404 to my HTTP fetcher and browser rungs were unavailable in this environment, so I cite the report URL surfaced by the ITS statistics pages and corroborate the share by summing the live ITS monthly table). If the OA-appointment share has drifted materially since 2022/23, the "about a tenth" phrasing would need updating — but this does not affect the Companies Office whole-of-market trend, which is the core result.
- **Could not verify:** exact 2022 and 2023 year-end register stock (used quarter-ends/endpoints instead); the precise methodological reason the ITS whole-of-market count (2,389 for FY2022/23) exceeds the Companies Office calendar-basis count (~1,750–1,800) — I attribute it to financial-vs-calendar year and dating/scope differences but did not obtain the ITS counting definition; and anything about *who* is failing or *why* (out of scope — see #273/#274).
...
All sources accessed 3 July 2026. Fetch method: the two Companies Office CSVs and the "Latest company statistics" HTML were fetched with `curl` and parsed/summed locally; the ITS pages were read via WebFetch and `curl` (raw HTML tables parsed locally); the ITS 2022/23 report PDF returned HTTP 404 to `curl`/WebFetch and the browser rungs (`scripts/fetch.mjs`) were unavailable in this environment, so the report figure is cited from the URL surfaced by the ITS statistics pages and independently corroborated by summing the live ITS monthly table.
...
6. Insolvency and Trustee Service. "Insolvency Statistics and Debtor Profile Report, 1 July 2022 to 30 June 2023." https://www.insolvency.govt.nz/assets/pdf/Statistical-Data-Reports/its-statistical-data-report-2022-23.pdf
