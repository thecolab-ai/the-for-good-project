...
| [`nz-superannuation-fiscal-sustainability-how-much-i-framing.md`](nz-superannuation-fiscal-sustainability-how-much-i-framing.md) | **Proposal** (July 2026) | Discovery framing for stream #440: NZ Super's cost baseline, OECD comparison, demographic pressure, Treasury sustainability path, reform options, and political feasibility — proposes five child research issues for runner-managed fan-out. |
