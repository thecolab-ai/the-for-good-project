...
| [`nz-housing-supply-vs-actual-building-consents-why-framing.md`](nz-housing-supply-vs-actual-building-consents-why-framing.md) | **Proposal** (July 2026) | Discovery framing for stream #435: corrects the target-versus-consents premise, sets the consent/completion baseline, and splits into six child research issues on capacity, council outliers, constraints, regional dynamics, public housing, and delivery levers. |
