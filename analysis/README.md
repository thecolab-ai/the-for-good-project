...
| [`nz-dairy-sector-water-use-and-consent-renewal-how-framing.md`](nz-dairy-sector-water-use-and-consent-renewal-how-framing.md) | **Proposal** (July 2026) | Discovery framing for stream #436: NZ dairy freshwater-consent risk, production exposure, farmer adaptation, regulatory trajectory, and international comparators — split into five child research issues. |
